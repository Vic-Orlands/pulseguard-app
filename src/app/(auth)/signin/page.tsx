...
function AuthScreen({ onToggleMode, handleOAuthLogin }: { onToggleMode: (mode: any) => void; handleOAuthLogin: (provider: string) => void }) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col gap-2.5 mb-6" id="oauth-buttons-wrapper">
        <motion.button
          id="btn-google-login"
          whileTap={{ scale: 0.99 }}
        ...
        >
          ...
          >
            {loadingProvider === 'github' ? (
              ...
              <HugeiconsIcon icon={GithubIcon} className="w-4 h-4 text-zinc-950" />
            )}
      ...
      <p className="text-[11px] leading-relaxed text-zinc-500 max-w-[290px] mb-8 select-none">
        ...
        <a href="#terms" className="hover:text-zinc-300 underline underline-offset-2 transition-colors">Terms of Service</a>
        {' '}&{' '}
        <a href="#privacy" className="hover:text-zinc-300 underline underline-offset-2 transition-colors">Privacy Policy</a>
      </p>
      ...
      <motion.button
        ...
        className="group inline-flex items-center gap-1.5 text-zinc-400 hover:text-white font-medium text-[13px] transition-colors duration-200 cursor-pointer focus:outline-none"
      >
