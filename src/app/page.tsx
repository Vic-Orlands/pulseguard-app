      ...
      <section className="pg-shell relative isolate flex min-h-[800px] items-center justify-center overflow-hidden border-b border-[#e4e4df] px-5 pb-24 pt-14 text-center sm:min-h-[860px]">
        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center">
          ...
          <div className="mt-20 w-full max-w-3xl rounded-2xl border border-[#e1e1dc] bg-white p-2 shadow-[0_22px_50px_rgba(30,30,20,.07)] sm:p-3">
            ...
            <div className="flex items-center gap-3 rounded-xl border border-[#e3e3de] px-4 py-3 text-left"><Search size={16} className="text-[#8a8a85]" /><span className="flex-1 text-xs font-light text-[#4b4b47]">service:checkout</span><button className="grid size-9 place-items-center rounded-lg bg-[#ff5a1f] text-white"><ArrowRight size={16} /></button></div>
          </div>
        </div>
      </section>
