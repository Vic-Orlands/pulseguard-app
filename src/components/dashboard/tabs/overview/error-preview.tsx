      ...
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          <CardTitle className="text-xl font-semibold text-white flex items-center">
            <HugeiconsIcon icon={Alert01Icon} className="w-5 h-5 text-red-400 mr-2" />
            Recent Errors
          </CardTitle>
        </div>
        ...
        <div className="space-y-4">
          {errors === null || errors.length === 0 ? (
            <div className="flex flex-col items-center justify-center min-h-[330px] p-8 text-gray-400">
              <HugeiconsIcon icon={Alert01Icon} className="w-12 h-12 mb-2" />
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                    <span className="flex items-center">
                      <HugeiconsIcon icon={Bug01Icon} className="w-3 h-3 mr-1" />
