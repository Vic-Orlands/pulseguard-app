            ...
            <Card className="bg-gradient-to-br from-blue-900/30 to-blue-800/20 border-blue-500/20">
              <CardContent className="flex items-center h-full justify-between">
                ...
                <div className="p-2 bg-blue-500/20 rounded-lg">
                  <HugeiconsIcon icon={UserGroupIcon} className="w-5 h-5 text-blue-400" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-yellow-900/30 to-yellow-800/20 border-yellow-500/20">
              <CardContent className="flex items-center h-full justify-between">
                ...
                <div className="p-2 bg-yellow-500/20 rounded-lg">
                  <HugeiconsIcon icon={Clock01Icon} className="w-5 h-5 text-yellow-400" />
                </div>
              </CardContent>
            </Card>
                          ...
                          <div className="bg-slate-900 border-slate-700 h-full px-6 text-white relative">
                            ...
                            <section className="grid grid-cols-2 gap-4 mb-6">
                              <div className="flex items-center gap-3 p-3 bg-slate-800/20 rounded-lg border border-slate-700/20">
                                <HugeiconsIcon icon={Clock01Icon} className="w-6 h-6 text-emerald-400 flex-shrink-0" />
                              ...
                              <div className="flex items-center gap-3 p-3 bg-slate-800/20 rounded-lg border border-slate-700/20">
                                <HugeiconsIcon icon={Bug01Icon} className="w-6 h-6 text-red-400 flex-shrink-0" />
                                <div className="min-w-0 flex-1">
                                  <div className="text-xs text-gray-400 mb-1">
                                    Errors
                                    <div className="text-lg font-semibold text-gray-200">
                            ...
                            <section className="grid grid-cols-2 gap-4 mb-6">
                              <div className="flex items-center gap-3 p-3 bg-slate-800/20 rounded-lg border border-slate-700/20">
                                <HugeiconsIcon icon={CalendarAdd01Icon} className="w-6 h-6 text-cyan-400 flex-shrink-0" />
                                <div className="min-w-0 flex-1">
                                  <div className="text-xs text-gray-400 mb-1">
                                    Event count
                              ...
                              <div className="flex items-center gap-3 p-3 bg-slate-800/20 rounded-lg border border-slate-700/20">
                                <HugeiconsIcon icon={Bookmark01Icon} className="w-6 h-6 text-cyan-400 flex-shrink-0" />
                                <div className="min-w-0 flex-1">
                                  <div className="text-xs text-gray-400 mb-1">
                                    PageView count
                                    <div className="text-sm text-gray-200">
                            ...
                            <div className="space-y-4">
                              <div className="flex items-center gap-3 p-3 bg-slate-800/20 rounded-lg border border-slate-700/20">
                                <HugeiconsIcon icon={UserIcon} className="w-6 h-6 text-purple-400 flex-shrink-0" />
                                <div className="min-w-0 flex-1">
                                  <div className="text-xs text-gray-400 mb-1">
                                    User ID
                                  </div>
                              ...
                              <section className="grid grid-cols-2 gap-4 mb-6">
                                <div className="flex items-center gap-3 p-3 bg-slate-800/20 rounded-lg border border-slate-700/20">
                                  <HugeiconsIcon icon={Calendar01Icon} className="w-6 h-6 text-cyan-400 flex-shrink-0" />
                                  <div className="min-w-0 flex-1">
                                    <div className="text-xs text-gray-400 mb-1">
                                      Started
                                    </div>
